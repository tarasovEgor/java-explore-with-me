...
//    public static List<EventRequestStatusUpdateResult> toEventRequestStatusUpdateResults(List<ParticipationRequest> requests) {
//
//
//        return toEventRequestStatusUpdateResult(requests);
//    }
}
